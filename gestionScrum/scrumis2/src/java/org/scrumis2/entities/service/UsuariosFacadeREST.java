...
import org.scrumis2.entities.Usuarios;
 ...
 */
//@javax.ejb.Stateless
@Path("org.scrumis2.entities.usuarios")
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {
    ...
    protected EntityManager getEntityManager() {
        return em=Persistence.createEntityManagerFactory("scrumis2PU").createEntityManager();
    }
