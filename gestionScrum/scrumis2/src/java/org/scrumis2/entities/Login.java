...
@NamedQueries({
    ...
    , @NamedQuery(name = "Login.findByContrasenha", query = "SELECT l FROM Login l WHERE l.contrasenha = :contrasenha")})
public class Login implements Serializable {
    ...
    public Login(Integer idLogin, String nombre, String contrasenha) {
        this.idLogin = idLogin;
        this.nombre = nombre;
    ...
    public String toString() {
        return "org.scrumis2.entities.Login[ idLogin=" + idLogin + " ]";
    }
